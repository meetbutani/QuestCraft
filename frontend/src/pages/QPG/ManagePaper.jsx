...
const ManagePaper = () => {
  ...
  const handleClick = () => {
    navigate("/qpaper/set-subject-paper");
  };
  ...
  const filteredData = Data.filter((item) => {
    ...
    return (
      searchTerm === "" ||
      item.paperType.toLowerCase().includes(searchTerm) ||
      item.paperName.toLowerCase().includes(searchTerm) ||
          ...
          <table className="w-full table-auto">
            <thead>
              <tr className="bg-gray-2 text-left dark:bg-meta-4 h-[60px]">
                ...
                <th
                  onClick={() => handleSorting("paperType", order)}
                  className="table-td-head"
                >
                  <span>
                    Paper Type
                ...
                <th
                  onClick={() => handleSorting("paperName", order)}
                  className="table-td-head"
                >
                  <span>
                    Paper Name
              ...
              {currentItems.map((packageItem, key) => (
                <tr key={key} className="h-[60px]">
                  ...
                  <td className="table-td-data max-w-[200px]">
                    <h5 className="font-medium text-black dark:text-white">
                      {packageItem.paperType}
                    </h5>
                  </td>
                  <td className="table-td-data max-w-[200px]">
                    <h5 className="text-black dark:text-white">
                      {packageItem.paperName}
                    </h5>
                  </td>
                  <td className="table-td-data max-w-[200px]">
                    <h5 className="text-black dark:text-white">
