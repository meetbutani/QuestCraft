...
const SelectQuestionForSectionGFinal = () => {
  ...
  const handleSubmit = () => {
    ...
    dataMap.sectionG = selectedQuestions;
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Select Question for Section G " />
...
export default SelectQuestionForSectionGFinal;
