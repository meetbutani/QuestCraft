...
const SelectQuestionForSectionCFinal = () => {
  ...
  const handleSubmit = () => {
    ...
    navigate("/qpaper/set-subject-paper/select-question-for-section-d-final");
  ...
  return (
    <DefaultLayout>
      <Breadcrumb pageName="Select Question for Section C " />
      <div className="flex justify-center">
        <div className="relative h-2.5 w-full xl:w-3/4 rounded-full bg-stroke dark:bg-strokedark m-10">
          ...
          <div className="absolute  h-full w-full xl:w-4/4 rounded-full bg-stroke dark:bg-strokedark">
            <div className="absolute left-0 h-full w-3/6 rounded-full bg-primary">
...
export default SelectQuestionForSectionCFinal;
