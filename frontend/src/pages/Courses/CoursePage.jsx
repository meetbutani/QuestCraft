          ...
          />
            ...
            <thead>
              ...
              <tr className="bg-gray-2 text-left dark:bg-meta-4">
                ...
                <th onClick={() => {sorting("course_name")}} className="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white xl:pl-11">
                  Course Name
                </th>
            ...
            <tbody>
              {Data.filter((item) => {
                return search.toLowerCase() === '' ? item : item.course_name.toLowerCase().includes(search);              }).map((packageItem, key) => (
                <tr key={key}>
