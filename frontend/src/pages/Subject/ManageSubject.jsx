...
const ManageSubject = () => {
  ...
  const handleDeleteClick = (id, subjectCode) => {
    // Show the delete dialog
    setIsDeleteDialogOpen(true);
    setSelectedSubject({ id: id, subjectCode: subjectCode });
  };
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      const response = await axios.delete(
        nodeBaseUrl + "/api/subject/" + selectedSubject.id
      );
    ...
    <DefaultLayout>
      ...
      <div className="flex justify-between items-center mb-4">
        <DeleteDialog
          ...
          title={"Delete User"}
          description={
            "Are you sure want to delete subject with subject code <b>'" +
                    ...
                    <div className="flex justify-center space-x-3.5">
                      ...
                      <button
                        onClick={() => {
                          ...
                          navigate(`/subject/edit-subject-details`);
                        }}
                        className="hover:text-primary"
                      >
                        <MdEdit color="#0000FF" />
