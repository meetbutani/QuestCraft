    ...
    >
      ...
      <div className="flex flex-row items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          ...
          <h1 className="flex text-title-xl font-bold text-bodydark1">
            Questcraft
          </h1>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/logout"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 text-red-500 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
