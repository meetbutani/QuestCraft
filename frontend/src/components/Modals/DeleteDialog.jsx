...
const DeleteDialog = ({ isOpen, title, description, onConfirm, onCancel }) => {
    if (!isOpen) return null;

    return (
        <div id="delete-dialog-backdrop" className="fixed left-0 top-0 z-999999 flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5 block">
            <div className="md:px-17.5 w-full max-w-142.5 rounded-lg bg-white px-8 py-12 text-center dark:bg-boxdark md:py-15">
                ...
                <p className="mb-10" dangerouslySetInnerHTML={{
                    __html: description,
                }}>
                </p>
